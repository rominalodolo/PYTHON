...
cloud2 = pygame.image.load('PythonGaming/game1_LoveRange/shootingRangeAssets/Cloud2.png')
crosshair = pygame.image.load('PythonGaming/game1_LoveRange/shootingRangeAssets/crosshair.png')
duck_surface = pygame.image.load('PythonGaming/game1_LoveRange/shootingRangeAssets/duck.png')
